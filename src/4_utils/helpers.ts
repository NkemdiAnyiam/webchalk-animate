...
//  */
// export function getStyles(element: Element, styleProps: StyleProperty[]): {[key: string]: string};
// /**
...
//  */
// export function getStyles(element: Element, styleProp: StyleProperty): string;
// export function getStyles(element: Element, styleProp_s: StyleProperty[] | StyleProperty) {
//   if (!element) { throw new CustomErrors.InvalidElementError(`Element must not be null or undefined.`); }

//   // create object that will store style props
//   const requestedProp_s = {} as any;
...
//     // @ts-expect-error
//     requestedProp_s[styleProp_s] = styleProp_s.startsWith('--') ? styleDec.getPropertyValue(styleProps_s) : styleDec[styleProp_s];
//   }
//   else {
//     for (const prop of styleProp_s) {
//       // @ts-expect-error
//       requestedProp_s[prop] = styleProp_s.startsWith('--') ? styleDec.getPropertyValue(prop) : styleDec[prop as string];
//     }
//   }

//   return requestedProp_s;
// }
