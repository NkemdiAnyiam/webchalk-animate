...
/**
 * A function that throws a detailed error using additional location information based on the {@link AnimTimeline}.
 */
...
/**
 * A function that throws an error with additional optional location information based on
...
class LateSchedulingError extends LockedOperationError {
  constructor(message: string) {
    super(message);
    this.name = 'LateSchedulingError';
  }
}
 ...
 * @param tip - The string containing extra information related to the error.
